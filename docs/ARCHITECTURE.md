...
Optional Direct touch combines the existing keyboard with a single-finger HID
report adapted from MIT WinBleTouch d80d659af53188c45d3d2966f86ec35c0849287f.
...
not. iPhone Zoom at 1x is a required setup assumption pending physical validation.
